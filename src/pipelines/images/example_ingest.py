...
# _print_chunk_summary() below prints box-drawing characters (─), which
# raise UnicodeEncodeError on an unconfigured Windows console (cp1252) —
# confirmed by actually running this script, not assumed. Same fix as
# smoke_test.py and scripts/verify_setup.py elsewhere in this repo.
